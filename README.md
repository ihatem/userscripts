...
A collection of handy userscripts for enhancing my web experience. Each script is designed to add useful features or remove annoyances from popular websites.
...
2. Click on the `.user.js` file you want to install, then click the `raw` button to install. You will be redirected to your userscript manager installation wizard.
